      ...
      <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-full md:h-[40rem] px-4 py-4">
        ...
        >
          <TextGenerateEffect
            duration={2}
            filter={true}
            words={"Contributions are always Welcome!"}
            // className="text-center text-[40px] md:text-6xl lg:text-7xl"
          />
          <p className="text-center text-base md:text-lg font-normal text-neutral-700 dark:text-neutral-200 max-w-md my-2 mx-auto">
            We are globally available, so you can contribute to this library
            from anywhere.
          </p>
        </motion.div>
